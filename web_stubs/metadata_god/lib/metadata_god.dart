...
class Metadata {
  ...
  const Metadata({this.title, this.artist, this.album, this.trackNumber, this.trackTotal, this.discNumber, this.discTotal, this.year, this.genre, this.comment, this.durationMs, this.bitrate, this.sampleRate, this.channels, this.picture});
}
class MetadataGod {
