      ...
      showModalBottomSheet(
        ...
        builder: (_) => DraggableScrollableSheet(
          ...
          builder: (ctx, sc) => Container(
            decoration: BoxDecoration(
              color: themeCs.surfaceContainer,
              borderRadius: const BorderRadius.vertical(top: Radius.circular(20)),
              border: Border.all(color: themeCs.outlineVariant.withValues(alpha: 0.35)),
            ),
            child: Column(
              children: [
                const SizedBox(height: 8),
                Container(width: 36, height: 4,
                  decoration: BoxDecoration(color: themeCs.outlineVariant, borderRadius: BorderRadius.circular(2))),
                const SizedBox(height: 16),
                Padding(
                  ...
                  child: Row(children: [
                    ...
                    const SizedBox(width: 8),
                    Text('Moteurs binaires', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: themeCs.onSurface)),
                  ]),
                ),
                const SizedBox(height: 4),
