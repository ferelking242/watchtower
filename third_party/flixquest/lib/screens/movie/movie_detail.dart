    ...
    return FutureBuilder<Images>(
      ...
      builder: (context, snapshot) {
        ...
        return Stack(
          ...
          children: [
            if (paths.isEmpty)
              Image.asset('packages/flixquest/assets/images/na_logo.png', fit: BoxFit.cover)
            else
              AppSwipeCarousel(
              ...
              child: SizedBox.square(
                ...
                child: ClipOval(
                  child: cast.profilePath == null
                      ? Image.asset('packages/flixquest/assets/images/na_rect.png',
                          fit: BoxFit.cover)
                      : CachedNetworkImage(
                          cacheManager: cacheProp(),
                          imageUrl: buildImageUrl(
                          ...
                          errorWidget: (_, __, ___) => Image.asset(
                            'packages/flixquest/assets/images/na_rect.png',
                            fit: BoxFit.cover,
                          ),
                        ),
                ),
              ...
              child: Stack(
                ...
                children: [
                  if (key == null || key.isEmpty)
                    Image.asset('packages/flixquest/assets/images/na_rect.png', fit: BoxFit.cover)
                  else
                    CachedNetworkImage(
                      cacheManager: cacheProp(),
