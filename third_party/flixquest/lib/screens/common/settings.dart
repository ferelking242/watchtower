...
class _SettingsState extends State<Settings> {
  ...
  Widget build(BuildContext context) {
    ...
    List<AppLanguages> langs = [
      AppLanguages(
          languageFlag: 'packages/flixquest/assets/images/country_flags/united-kingdom.png',
          languageName: tr('english'),
          languageCode: 'en'),
      AppLanguages(
          languageFlag: 'packages/flixquest/assets/images/country_flags/united-arab-emirates.png',
          languageName: tr('arabic'),
          languageCode: 'ar'),
      AppLanguages(
          languageFlag: 'packages/flixquest/assets/images/country_flags/spain.png',
          languageName: tr('spanish'),
          languageCode: 'es'),
      AppLanguages(
          languageFlag: 'packages/flixquest/assets/images/country_flags/india.png',
